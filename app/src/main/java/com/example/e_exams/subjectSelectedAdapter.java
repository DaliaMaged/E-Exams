...
public class subjectSelectedAdapter extends RecyclerView.Adapter<subjectSelectedAdapter.ViewHolder> {
    ...
    public subjectSelectedAdapter( Context context,ArrayList<String>arrayList, subjectSelectedListener subjectSelectedListener) {
...
//                        user.setSubjectList(String.valueOf(item));
